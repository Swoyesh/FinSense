...
import ClassificationPage from './components/budget/ClassificationPage';
    ...
    <div className="h-screen bg-linear-to-br from-gray-950 via-gray-900 to-gray-950 text-white flex flex-col overflow-hidden">
      ...
      <div className="flex flex-1 overflow-hidden">
        ...
        <main className={`flex-1 ${user ? 'lg:ml-72' : ''} overflow-hidden`}>
          ...
          {currentPage === 'classification' && user && (
            <ClassificationPage token={token} user={user} onAuthRequired={handleAuthRequired} />
          )}

          {currentPage === 'budget' && user && (
            <BudgetPage token={token} user={user} onAuthRequired={handleAuthRequired} />
          )}

          {!user && currentPage !== 'chat' && (
