...
import { MessageCircle, TrendingUp, BarChart3, Menu, Sparkles } from 'lucide-react';
          ...
          <div className="pt-6 mt-6 border-t border-gray-800">
            <div className="bg-linear-to-br from-blue-600 to-purple-600 p-4 rounded-xl">
              ...
              <p className="text-xs text-blue-100 leading-relaxed">
                Use classification to analyze transactions and budgeting to manage income & savings efficiently!
              </p>
            </div>
          </div>
        </nav>
